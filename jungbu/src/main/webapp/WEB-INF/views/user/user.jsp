					...
					<div class="col-lg-12">
						...
						<div class="tabs d-flex flex-row align-items-center justify-content-start flex-wrap">
							...
							<c:forEach var="i" begin="1" end="12">
								<div class="tab">
									<div class="tab_title">${i }월 생일이신 분 </div>
									<br>
									<div class="tab_text">
										<table style="border: 1px solid #444444; width: 100%;">
											<tr style="border: 1px solid #444444;">
												<td style="border: 1px solid #444444; text-align: center; width: 20%;">
													<font color="black"><b>성명</b></font>
												</td>
												<td style="border: 1px solid #444444; text-align: center; width: 40%;">
													<font color="black"><b>양력 생년월일</b></font>
												</td>
												<td style="border: 1px solid #444444; text-align: center; width: 40%;">
													<font color="black"><b>음력 생년월일</b> </font>
												</td>
											</tr>
											<c:forEach items="${users}" var="user" varStatus="status">
												<c:if test="${user.isMoon eq true }">
													<c:if test="${user.month_moon eq i }">
														<td style="border: 1px solid #444444; text-align: center;">
															<font color="black">${user.name}</font>
														</td>
														<td style="border: 1px solid #444444; text-align: center;">
															<font color="black">${user.month_moon}월 ${user.day_moon}일</font>
														</td>
														<td style="border: 1px solid #444444; text-align: center;">
															<font color="black">${user.month}월 ${user.day}일</font>
														</td>
														</tr>
													</c:if>
												</c:if>
												<c:if test="${user.isMoon eq false }">
													<c:if test="${user.month eq i }">
														<td style="border: 1px solid #444444; text-align: center;">
															<font color="black">${user.name}</font>
														</td>
														<td style="border: 1px solid #444444; text-align: center;">
														...
														<td style="border: 1px solid #444444; text-align: center;">-</td>
														</tr>
													</c:if>
												</c:if>
											</c:forEach>
