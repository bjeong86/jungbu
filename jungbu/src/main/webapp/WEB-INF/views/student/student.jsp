					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">학생부회의록</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="tabs d-flex flex-row align-items-center justify-content-start flex-wrap">
							<c:forEach items="${studentInfo}" var="student" varStatus="status">
								<div class="tab">
									<div class="tab_title">[${student.title}] 학생부 회의</div>
									<br>
									<div class="tab_text">
										<font color="black">${student.contents}</font>
									</div>
								</div>
							</c:forEach>
							<div class="tab">
								<form id="studentInput" method="post" action="/saveStudent.do">
									<div class="tab_title">회의 내용 입력</div>
									<br>
									<div class="tab_text1">
										<textarea name="studentText" rows="7" style="width: 100%"></textarea>
									</div>
									<div class="tab_text">
										비밀번호: <br> <input type="password" name="pwd" style="width: 100%;" />
									</div>
									<div class="tab_text">
