			...
			<div class="menu trans_500">
				<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
					...
					<ul>
						...
						<li class="menu_item"><a href="#">연대기성경</a></li>
										...
										<div class="header_top_content d-flex flex-row align-items-center justify-content-start">
											...
											<div class="header_top_extra d-flex flex-row align-items-center justify-content-start ml-auto">
												<div class="header_top_phone">
													<i class="fa fa-phone" aria-hidden="true"></i> <span>+34 586 778 8892</span>
												</div>
											</div>
												...
												<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
													<nav class="main_nav">
														<ul class="d-flex flex-row align-items-center justify-content-start">
															...
															<li><a href="about.html">연대기성경</a></li>
						...
						<div class="col">
							<div class="cta_container d-flex flex-xl-row flex-column align-items-xl-start align-items-center justify-content-xl-start justify-content-center">
								<div class="cta_content text-xl-left text-center">
									...
									<div class="cta_subtitle">하나님이 미리 아신 자들을 또한 그 아들의 형상을 본받게 하기 위하여 미리 정하셨으니 이는 그로 많은 형제 중에서 맏아들이 되게 하려 하심이니라. (롬 8:29)</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row icon_boxes_row">
						...
						<div class="col-xl-4 col-lg-6">
							<div class="icon_box">
								<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
									<div class="icon_box_title">일요일</div>
								</div>
								<div class="icon_box_text">
									. 09.00 - 10.30 : 교회학교(학생부/성인부)<br> . 11.00 - 12.00 : 예 배<br> . 12.00 - 13.00 : 말 씀 / 연대기성경공부<br> . 13.00 - 14.00 : 애 찬<br> . 14.00 - 16.00 : 소그룹 활동/찬양집회
								</div>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-6">
							<div class="icon_box">
								<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
									<div class="icon_box_title">화요일</div>
								</div>
								<div class="icon_box_text">. 10.30 - 12.30 : 자매회</div>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-6">
							<div class="icon_box">
								<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
									<div class="icon_box_title">수요일</div>
								</div>
								<div class="icon_box_text">
									. 20.00 - 21:00 : 말씀집회<br>. 21.00 - 22.00 : 기도집회
								</div>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-6">
							<div class="icon_box">
								<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
									<div class="icon_box_title">금요일</div>
								</div>
								<div class="icon_box_text">. 20.00 - 22.00 : 양육반</div>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-6">
							<div class="icon_box">
								<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
									<div class="icon_box_title">토요일</div>
								</div>
								<div class="icon_box_text">. 19.00 - 21.00 : 청년부</div>
							</div>
						</div>
									...
									<div class="owl-carousel owl-theme dept_slider">
										...
										<div class="owl-item dept_item">
											...
											<div class="dept_content">
												...
												<div class="dept_link">2018 여름수양회말씀 이억용br</div>
											</div>
										</div>
										...
										<div class="owl-item dept_item">
											...
											<div class="dept_content">
												...
												<div class="dept_link">GNTV 송찬호</div>
											</div>
										</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 footer_col">
								<div class="footer_about">
									...
									<div class="footer_about_text">하나님이 미리 아신 자들을 또한 그 아들의 형상을 본받게 하기 위하여 미리 정하셨으니 이는 그로 많은 형제 중에서 맏아들이 되게 하려 하심이니라. (롬 8:29)</div>
									<div class="copyright">
							...
							<div class="col-lg-6 footer_col">
								<div class="footer_hours">
									<div class="footer_hours_title">주일 예배 일정</div>
									<ul class="hours_list">
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div>교회학교(학생부/성인부)</div>
											<div class="ml-auto">9.00 – 10.30</div>
										</li>
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div>예 배</div>
										...
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div>말 씀 / 연대기성경공부</div>
											<div class="ml-auto">12.00 – 13.00</div>
										</li>
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div>애 찬</div>
											<div class="ml-auto">13.00 – 14.00</div>
										</li>
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div>소그룹 활동/찬양집회</div>
											<div class="ml-auto">14.00 – 16.00</div>
										</li>
									</ul>
								</div>
							</div>
