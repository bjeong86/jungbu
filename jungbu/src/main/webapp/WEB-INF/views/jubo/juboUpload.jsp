...
<body>
	...
	<div class="super_container">
		...
		<div class="home">
			...
			<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="${pageContext.request.contextPath}/resources/images/about.jpg" data-speed="0.8"></div>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">수원중부교회 주보 업로드</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-xl-10 col-md-10">
						<div class="col text-center">
							<div class="section_title">주보 업로드</div>
							<br> <br>
							<form method="post" action="/juboFileUpload.do" enctype="multipart/form-data">
								<table>
									<tr>
										<td align="left">
											<div class="doctor_name">년도 : &nbsp;&nbsp;&nbsp;</div>
										</td>
										<td align="left">
											<select name="year">
												<option value="<fmt:formatDate value="${toDay}" pattern="YYYY" />"><fmt:formatDate value="${toDay}" pattern="YYYY" /></option>
												<c:forEach var="i" begin="2019" end="2023" step="1">
									...
									<tr>
										<td align="left">
											<div class="doctor_name">월 : &nbsp;&nbsp;&nbsp;</div>
										</td>
										<td align="left">
											<select name="month">
												<option value="<fmt:formatDate value="${toDay}" pattern="MM" />"><fmt:formatDate value="${toDay}" pattern="MM" /></option>
									...
									<tr>
										<td align="left">
											<div class="doctor_name">일 : &nbsp;&nbsp;&nbsp;</div>
										</td>
										<td align="left">
											<select name="day">
												<option value="<fmt:formatDate value="${toDay}" pattern="dd" />"><fmt:formatDate value="${toDay}" pattern="dd" /></option>
